sap.ui.define([
	"sap/ui/test/Opa5",
	"com/salesbom/culligan/salesbomdisplay/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.salesbom.culligan.salesbomdisplay.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.salesbom.culligan.salesbomdisplay",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "MaterialBOMItem/" + sObjectId;
