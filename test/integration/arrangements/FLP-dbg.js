...
sap.ui.define([
	...
	"com/salesbom/culligan/salesbomdisplay/test/flpSandbox"
	...
	return Opa5.extend("com.salesbom.culligan.salesbomdisplay.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "MaterialBOMItem/" + encodeURIComponent(sObjectId);
