		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales BOM Display",
									"targetURL": "#SalesBOMDisplay-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SalesBOMDisplay-display": {
								"semanticObject": "SalesBOMDisplay",
								"action": "display",
								"description": "Sales BOM Display",
								"title": "Sales BOM Display",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.salesbom.culligan.salesbomdisplay",
									"url": sap.ui.require.toUrl("com/salesbom/culligan/salesbomdisplay")
								}
							}
						}
					}
